...
public class DoctorService {
    ...
    public Map<String, Object> filterDoctorByTimeAndSpecility (String amOrPm, String speciality){
        List<Doctor> doctors = new ArrayList<>();
        List<Doctor> doctorsFiltered = new ArrayList<>();
        Map<String, Object> response = new HashMap<>();
    ...
    public List<Doctor> filterDoctorBySpeciality (String speciality, List<Doctor> doctors){
        List<Doctor> doctorsFiltered = new ArrayList<>();
     ...
     */
    public List<Doctor> filterDoctorByName (String name, List<Doctor> doctors){
        List<Doctor> doctorsFiltered = new ArrayList<>();
